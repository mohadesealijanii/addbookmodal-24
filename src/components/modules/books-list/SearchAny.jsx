...
function SearchAny({ handleAny, anyValue, setAnyValue, setSearchRow }) {
  ...
  return (
    <div className="relative w-full">
      <div className="flex px-2 mt-3 justify-between">
        <div className="relative w-full">
          <LuSearch
            className="bg-sea hover:bg-sea cursor-pointer shadow-md w-9 h-9 p-1 absolute right-1 top-[23px] -translate-y-1/2 rounded transition-all"
            size={15}
            color="white"
            onClick={handleAny}
          />
